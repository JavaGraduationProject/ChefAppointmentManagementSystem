...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>厨艺厨师管理 <span class="c-gray en">&gt;</span> 个人信息
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="teacher/personal.action" name="myform" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="teachername" class="input-text" id="teachername" value="${teacher.teachername}" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="workdate" class="input-text" id="workdate" value="${teacher.workdate}" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="contents" id="contents" value="${teacher.contents}" />
