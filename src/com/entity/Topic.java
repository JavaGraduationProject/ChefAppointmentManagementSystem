...
return "Topic [topicid="+this.topicid+", usersid="+this.usersid+", ordersid="+this.ordersid+", teacherid="+this.teacherid+", num="+this.num+", contents="+this.contents+", addtime="+this.addtime+", username="+this.username+", ordercode="+this.ordercode+", teachername="+this.teachername+"]";
}
