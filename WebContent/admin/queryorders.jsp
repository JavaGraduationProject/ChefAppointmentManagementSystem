...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>私教预约管理 <span class="c-gray en">&gt;</span> 私教预约查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="8">私教预约查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${ordersList}" var="orders">
				<tr class="text-c">
					...
					<td class="center">${orders.teachername}</td>
					<td class="center">${orders.orderdate}</td>
					<td class="center">${orders.sectionx}</td>
		...
		<div class="text-c">
			<form action="orders/queryOrdersByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="sectionx">按时间段查询</option>
