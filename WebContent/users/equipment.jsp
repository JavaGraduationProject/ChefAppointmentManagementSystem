					...
					<div class="clearfix goodsBox" style="border: none;">
						<c:forEach items="${equipmentList}" var="equipment">
							<div class="goodsItem" style="padding: 10px 3px 15px 2px;">
								<a href="index/equipmentDetail.action?id=${equipment.equipmentid }"><img src="${equipment.image }" alt="${equipment.equipname }"
									class="goodsimg" /> </a> <br />
								<p class="f1">
									<a href="index/equipmentDetail.action?id=${equipment.equipmentid }" title="${equipment.equipname }">${equipment.equipname }</a>
								</p>
							</div>
						</c:forEach>
					</div>
