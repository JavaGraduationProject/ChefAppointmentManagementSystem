...
public class TopicController extends BaseController {
	...
	@RequestMapping("getTeacherTopic.action")
	public String getTeacherTopic(String number) {
		String adminid = (String) this.getSession().getAttribute("adminid");
		Topic topic = new Topic();
		topic.setTeacherid(adminid);
		List<Topic> topicList = this.topicService.getTopicByCond(topic);
		PageHelper.getUserPage(topicList, "topic", "getTeacherTopic", 10, number, this.getRequest());
